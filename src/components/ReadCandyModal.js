  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      ...
      >
        ...
        <button
          onClick={onClose}
          className=" w-full h-12 content-center mt-4 m bg-pink-200 text-amber-950 flex justify-center items-center rounded-lg font-bold text-center shadow-gray-400 shadow-md"
        >
          닫기
        </button>
